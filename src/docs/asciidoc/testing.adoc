...
class. If your class is named `com.example.myTest.MyTest`, `GenericXmlContextLoader` loads your
application context from `"classpath:com/example/myTest.MyTest-context.xml"`. The following
...
----
	...
	// "classpath:com/example/myTest.MyTest-context.xml"
...
`com.example.myTest.MyTest`, the Groovy context loader loads your application context from
...
if the annotated test class is `com.example.myTest.MyTest`, the corresponding default properties
file is `classpath:com/example/myTest.MyTest.properties`. If the default cannot be detected, an
...
* Class-level declaration: If the annotated test class is `com.example.myTest.MyTest`, the
  corresponding default script is `classpath:com/example/myTest.MyTest.sql`.
* Method-level declaration: If the annotated test method is named `testMethod()` and is
  defined in the class `com.example.myTest.MyTest`, the corresponding default script is
  `classpath:com/example/myTest.MyTest.testMethod.sql`.
